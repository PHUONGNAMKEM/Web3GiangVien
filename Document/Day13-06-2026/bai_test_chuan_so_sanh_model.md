...
**Ngày:** 13/06/2026 · **Script:** [ml-service/scripts/benchmark_sts.py](../../ml-service/scripts/benchmark_sts.py) · **Phần cứng:** CPU
...
> ⚠️ *Lưu ý khách quan:* điểm tương đồng là **của người thật**, nhưng câu tiếng Việt là **dịch máy** từ bản gốc → con số tuyệt đối mang tính tham khảo; **so sánh tương đối giữa các model là công bằng** vì mọi model nhận cùng dữ liệu, cùng tiền xử lý.
...
![Tương quan với điểm người](benchmark_sts_correlation.png)
...
1. **Đo đúng thứ hệ thống dùng.** Luồng chấm trong [phobert_analyzer.py](../../ml-service/models/phobert_analyzer.py) cho điểm bằng **cosine** giữa embedding *đoạn báo cáo* và *tiêu chí*. STS đo **chính xác** năng lực đó: cosine có phản ánh độ giống nghĩa mà người cảm nhận không. Không thêm tầng huấn luyện nào che mất bản chất.
...
**Tài liệu liên quan:** [báo cáo phân tích chi tiết](benchmark_sts_report.md) · [bảng kết quả](benchmark_sts_table.md)
